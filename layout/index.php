...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top ">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="main">
        ...
        <a href="signin.php" id="sign-up" class="  btn  me-2 ms-2 rounded-pill btn-primary" >S'inscrire</a>
        <a href="connecter.php" class="btn  rounded-pill btn-primary" >Se-connecter</a>
  ...
  <div class="landing d-flex justify-content-center align-items-center">
    <div class="text-center text-light">
      ...
      <a class="  btn btn-primary me-2 ms-2 rounded-pill " href="signin.php">Rendez-vous</a>
    </div>
  </div>
  <!-- herosection end  -->
                ...
                <div class="row align-items-center g-4">
                  ...
                  <div class="col-6">
                    ...
                    <div class="d-flex gap-2">
                     <a href="signin.php"> <button class="btn btn-primary mb-2">Prendre un Rendez-vous !</button></a>
                      <a href="medecin.php"><button class="btn btn-outline-secondary btn-sm">Voir Plus</button></a>
                    </div>
                  </div>
                </div>
              </div>
